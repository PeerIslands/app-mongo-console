                  ...
                  body: StaggeredGridView.count(
                    ...
                    children: <Widget>[
                      MaterialTile(
                        child: Padding(
                            ...
                            child: BlocBuilder<ProcessBloc,
                              ...
                              else if (state is ProcessStateClass.DataFailed) {
                                return DropdownSearch<String>(
                                    mode: Mode.BOTTOM_SHEET,
                                    showSelectedItem: true,
                                    items: [],
                                    label: "Select the instance",
                                    onChanged: print);
                              } else if (state is ProcessStateClass.DataLoaded) {
                                return DropdownSearch<String>(
                                    mode: Mode.BOTTOM_SHEET,
                                    showSelectedItem: true,
                                    items: state.processes.map((e) => e.id).toList(),
                                    label: "Select the instance",
                                    onChanged: print);
                              }
                              return DropdownSearch<String>(
                      ...
                      BlocBuilder<MeasurementBloc,
                          ...
                          builder: (context, state) {
                        var params = [
                          PathGroup('60a7d551089dc0628e6b8e08'),
                          PathProcess(
                              'atlas-a2nmrg-shard-00-00.wxkgt.mongodb.net:27017'),
                          ParamGranularity('PT24H'),
                          ParamMeasurement('OPCOUNTER_GETMORE'),
                          ParamStDate('2021-06-02T18:08:38Z'),
                          ParamEndDate('2021-06-08T18:08:38Z')
                        ];

                        // context.read<MeasurementBloc>().add(
                        //     MeasurementEventClass.FetchDataRequested(params));
                        return MaterialTile(child: BarChartItem());
                      })
                    ],
                    staggeredTiles: [
