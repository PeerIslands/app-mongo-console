...
class BottomMenuBloc extends Bloc<MenuEvent, BottomMenuState> {
  ...
  static List<MenuItem> _initialState() => [
        ...
        MenuItem(Icon(Icons.stacked_bar_chart, color: Colors.white, size: 35),
            null, true, 'Metrics'),
        MenuItem(Icon(Icons.network_wifi, color: Colors.white, size: 35), NetworkAccessPage(),
            false, 'Network'),
        MenuItem(Icon(Icons.pie_chart, color: Colors.white, size: 35), DatabaseAccessPage(),
            false, 'Databases'),
